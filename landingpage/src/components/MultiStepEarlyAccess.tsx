 ...
 *
 * Lives inside the EarlyAccessDialog modal, so this component doesn't
 * provide its own surface — it only renders the steps.
 *
 * Step 1: email (required)
 * Step 2: role (optional, qualifying)
 * Step 3: use case (optional, free text)
 *
 * Submits directly to Supabase via src/lib/supabase.ts.
 */
...
export function MultiStepEarlyAccess() {
  ...
  if (status === 'success') {
    return (
      ...
      >
        <span className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-foreground text-background shadow-elegant">
        ...
        {step === 1 && (
          ...
          >
            ...
            <input
              ...
              className="input-pill w-full mt-3"
            />
            ...
            <div className="mt-3 grid gap-2">
              {ROLES.map((r) => {
                ...
                return (
                  ...
                  >
                    <span>{r}</span>
                    {selected && <Sparkles className="h-4 w-4" />}
                  </button>
                );
              })}
            </div>
        ...
        {step === 3 && (
          ...
          >
            ...
            <textarea
              ...
              className="input-area w-full mt-3"
            />
