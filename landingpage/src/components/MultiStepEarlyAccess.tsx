 ...
 *
 *   1. What do you do? (role — "Something else" opens a text field)
 *   2. When do you want access? (4 clean options)
 *   3. What's your email?
 *   4. What should we call you? (name — last step)
 *   → Success: celebration with particles
 */
...
export function MultiStepEarlyAccess() {
  ...
  if (status === 'success') {
    return (
      ...
      >
        {/* Confetti particles rising from below */}
  ...
  return (
    <div>
      ...
      <AnimatePresence mode="wait">
        {/* ── Step 1: Role (with "Something else" text field) ─────── */}
        {step === 1 && (
          <motion.div key="s1" variants={stepVariants} initial="enter" animate="center" exit="exit" transition={stepTransition}>
            ...
            {/* "Something else" text field — appears when Other is selected */}
            <AnimatePresence>
              {showOtherField && (
                <motion.div
        ...
        {/* ── Step 2: When do you want access? ───────────────────── */}
        {step === 2 && (
