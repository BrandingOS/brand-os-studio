  ...
  return (
    <section className="section panel-dark bg-dot-grid">
      <div className="container-tight">
        <div className="relative overflow-hidden rounded-tl-3xl rounded-tr-none rounded-b-3xl p-10 md:p-14 max-w-5xl mx-auto text-center flex flex-col items-center justify-center">
