...
export interface LogoPresentationDoc {
  ...
  /**
   * Per-slide HTML snapshots — the latest cleaned innerHTML after the
   * user has edited the slide. Re-injected on mount so edits survive
   * page reload. Keyed by slide id.
   */
