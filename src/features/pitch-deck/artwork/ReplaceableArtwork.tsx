 ...
 * it for an uploaded photo or an Unsplash photo.
 *
 *   <ReplaceableArtwork slotId="cover-A-globe" defaultQuery="globe students">
...
export function ReplaceableArtwork({
  ...
  const [override, setOverride, clearOverride] = useArtworkSlot(slug ?? 'unknown', slotId);
