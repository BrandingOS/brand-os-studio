...
function brandSubpages(slug: string, name: string): SearchItem[] {
  return [
    ...
    { id: `b:${slug}:folders`, kind: 'asset', title: `${name} · Folders`, subtitle: 'Brand asset folders — logos, photos, icons', group: 'Brands', icon: 'asset', href: `/b/${slug}/folders`, keywords: [name, 'folders', 'dam', 'upload', 'library', 'assets'] },
