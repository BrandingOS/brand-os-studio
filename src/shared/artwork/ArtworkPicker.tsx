/**
 * ArtworkPicker — replace an SVG illustration with a photo or a 3D
 * illustration.
 *
 * Three tabs:
 *   - 3D Illustrations: Iconify search (no API key) over Fluent Emoji,
 *     Noto, Streamline, Flat Color Icons, Twemoji
