...
/**
 * BrandKitModulePage — renders a deep-editor module (profile icons,
 * business cards, etc.) INSIDE the BrandRouteLayout shell so the brand
 * sidebar stays mounted. No BrandLayout wrapper — the parent provides it.
 */
