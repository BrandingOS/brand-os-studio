...
- [ ] T008 Deploy migrations per the repo runbook: `supabase migration list --linked` → `supabase db push --linked` → `supabase migration list --linked` confirming 016 and 017 appear in BOTH columns. **If `db push` errors, do NOT force.** Record the outcome in `docs/phase-2/DEPLOY-016-020-runbook.md`.
...
Full detail in `docs/phase-2/DEPLOY-016-020-runbook.md`.
