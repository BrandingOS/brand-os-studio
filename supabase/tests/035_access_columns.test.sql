...
BEGIN
  ...
  BEGIN
    INSERT INTO public.workspace_members (workspace_id,user_id,role,role_v2,brand_access_mode,default_brand_role)
      VALUES ('aaaaaaaa-0000-0000-0000-000000000035','33333333-0000-0000-0000-000000000035','admin','admin','all','editor');
    RAISE EXCEPTION '035: admin with a default brand role was accepted';
  EXCEPTION WHEN check_violation THEN NULL; END;
  -- member is free
  INSERT INTO public.workspace_members (workspace_id,user_id,role,role_v2,brand_access_mode,default_brand_role)
    VALUES ('aaaaaaaa-0000-0000-0000-000000000035','44444444-0000-0000-0000-000000000035','editor','member','selected','designer');
