...
export function serializeJs(t: Typescale): string {
  ...
  return `// Generated by BrandingOS Typescale. Paste into a .ts file.
  ...
  return (
    <article className="rounded-lg border p-6 space-y-4">
      ...
      <p style={styleFor(draft, activeSurface, 'body')}>
        BrandingOS turns one typographic decision into a system — for web, UI, presentations, and social
